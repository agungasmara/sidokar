                                ...
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="col-sm-2 control-label">Nama Document</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">                          
                                                <div class="input-group" style="width: 100%!important;">
                                                    <vuejs-datepicker ref="endYearPicker" :format="customFormatter" :minimum-view="'year'" input-class="form-control clearFormInput" :value="new Date()" v-model="document.periode_start" name="periode_gaji" Placeholder="End Year"></vuejs-datepicker>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div v-if="true">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1" class="col-sm-2 control-label">Link Hardcopy</label>
                                                <div class="col-sm-10" v-if="!isuploadUlangDocumentHardcopy">
                                                    <div class="box-body2">
                                                        <a class="btn btn-block btn-social btn-bitbucket" :href="hrefFileDocumentHardcopy" download>
                                                            <i class="fa fa-download"></i> {{hrefFileDocumentHardcopy}}
                                                        </a>
                                                    </div>                                              
                                                    <button type="button" class="btn btn-success" @click="isuploadUlangDocumentHardcopy=true;showUploadDocumentHardcopy=true;isprosesUploadDocumentHardcopy=false">
                                                            Upload Ulang
                                                    </button>
                                                </div> 
                                                ...
                                                <div class="col-sm-10" v-if="isuploadUlangDocumentHardcopy">
                                                    <div v-if="showUploadDocumentHardcopy">
                                                        <input type="file" id="fileSuratPermohon" ref="fileDocumentHardcopy" v-validate="'required|size:2000'" name="fileDocumentHardcopy" data-vv-scope="step2" accept="application/pdf,image/x-png,image/gif,image/jpeg,image/jpg">
                                                        <span class="text-red">{{ errors.first('step2.fileSuratPermohonName') }}</span>
                                                        <p class="help-block">Upload Document *.pdf or *.jpg or *.jpeg or *.png</p>
                                                    </div>
                                                    <div v-if="isprosesUploadDocumentHardcopy">
                                                        <span class="text-red">Mohon Menunggu, Sedang Proses <vue-blink> Upload...</vue-blink></span>
                                                    </div>
                                                    <button type="button" class="btn btn-danger" @click="uploadFileDocumentHardcopy();isprosesUploadDocumentHardcopy=true;showUploadDocumentHardcopy=false">
                                                            Upload File
                                                    </button>
                                                </div>
